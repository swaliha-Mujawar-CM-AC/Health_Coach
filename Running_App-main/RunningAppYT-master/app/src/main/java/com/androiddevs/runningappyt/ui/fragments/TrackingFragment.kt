...
import com.androiddevs.runningappyt.other.Constants.MAX_ZOOM
...
const val CANCEL_TRACKING_DIALOG_TAG = "CancleDialog"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            val cancelTrackingDialog = parentFragmentManager.findFragmentByTag(
                CANCEL_TRACKING_DIALOG_TAG)as CalcelTrackingDialog?
